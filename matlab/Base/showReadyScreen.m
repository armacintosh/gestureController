...
% if exists bring to foreground else open it
% if ~isempty(findobj('type','figure','name','Connected again!')) % if alredy exists
...
%   make the connected again window
    ...
    WinOnTop(const.Ready.fh); % always keeps this window on top
