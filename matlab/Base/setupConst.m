...
const.param.sf = const.sf;           % set sampling frequency (2500 in the demo)
const.param.bins = 100;         % output i.e. parameter quantization levels
const.param.alpha = 10^-10;     % sets diffusion rate (10^-10 in Example)
const.param.beta = 10^-2;       % sets probability of sudden jumps (10^-40 in example) - makes more sensitive to jumps
const.param.model = 'Laplace';  % choose between 'Laplace' and 'Gauss' ('Gauss' seems more sensitive)
